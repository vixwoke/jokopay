...
export default function DashboardPage() {
  ...
  const [draftPref, setDraftPref] = useState<number>(0);
  ...
  return (
    <div className="flex min-w-0 flex-1 overflow-x-hidden">
      ...
      <section className="hidden min-w-0 flex-1 px-4 pb-4 pt-[4.5rem] lg:block">
        <DashboardPanel refreshKey={refreshKey} />
      </section>
      <main className="flex min-w-0 w-full flex-col px-4 pb-4 pt-[4.5rem] lg:w-[420px] lg:shrink-0">
        <Suspense fallback={<div className="flex flex-1 items-center justify-center text-sm text-zinc-400">Loading...</div>}>
          <ChatView onTransactionSaved={handleTxSaved} />
        </Suspense>
      </main>
